      ...
      <div className="relative max-w-[1200px] mx-auto w-full px-16 sm:px-6 max-sm:px-4 py-20 sm:py-14 md:py-36 grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
        ...
        <div className="md:col-span-6 flex flex-col gap-7">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <Link
              href="/#services"
              className="inline-flex items-center gap-2 bg-brand-primary text-brand-on-primary text-sm font-semibold px-7 py-3.5 rounded-full hover:bg-brand-primary-container transition-colors duration-200 shadow-lg shadow-brand-primary/20"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-transparent text-brand-primary text-sm font-semibold px-7 py-3.5 rounded-full border-2 border-brand-primary/30 hover:border-brand-primary hover:bg-brand-primary/5 transition-all duration-200"
            >
              Contact Us
            </Link>
          </div>
        ...
        <div className="md:col-span-6 relative">
          ...
          <div className="absolute -bottom-5 -left-5 max-sm:hidden bg-brand-surface-container-lowest rounded-xl shadow-xl shadow-brand-primary/10 border border-brand-secondary/10 p-4 flex items-center gap-3">
