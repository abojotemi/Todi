      ...
      <div className="relative max-w-[1200px] mx-auto px-16 sm:px-6 max-sm:px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          <div className="order-2 md:order-1 relative">
            <div className="relative h-[360px] sm:h-[440px] md:h-[520px] rounded-2xl overflow-hidden shadow-2xl shadow-brand-primary/15">
              <Image
          ...
          <div className="order-1 md:order-2 flex flex-col gap-6">
            ...
            <p className="text-base leading-7 text-brand-on-surface-variant">
              ...
              commitment to quality. We partner with government agencies, private
              hospitals, and specialised clinics to ensure that medical
              professionals have access to the knowledge and tools necessary to
              save lives.
            </p>

            <div className="mt-2 pt-6 border-t border-brand-secondary/15 space-y-3">
              <div className="flex items-center gap-3 text-brand-primary">
                <MapPin size={18} className="text-brand-teal shrink-0" aria-hidden />
                <span className="text-sm font-semibold">
                  Main Office: Plo497, Cadastral Zone BO8, Jahi District Abuja, Nigeria.
                </span>
              </div>
              <div className="flex items-center gap-3 text-brand-primary">
                <MapPin size={18} className="text-brand-teal shrink-0" aria-hidden />
                <span className="text-sm font-semibold">
                  Branch: Plot 5A Block LVII, Off Sola Ajetomobi Street, Oba-Ile Housing Estate, Akure, Ondo State, Nigeria.
                </span>
              </div>
            </div>
          </div>
