    ...
    >
      ...
      <div className="relative max-w-[1200px] mx-auto px-16 sm:px-6 max-sm:px-4">
            ...
            <li key={item.label}>
              <a
                ...
                {...(item.external
                  ...
                  : {})}
                className="group flex flex-col items-center text-center bg-white/5 hover:bg-white/10 border border-white/10 hover:border-brand-teal/40 rounded-2xl p-8 transition-all duration-300"
              >
                <div className="w-14 h-14 rounded-full bg-brand-teal/15 border border-brand-teal/30 flex items-center justify-center text-brand-teal mb-5 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="text-center">
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 bg-brand-teal text-white text-sm font-semibold px-8 py-4 rounded-full hover:bg-brand-teal-dim transition-colors duration-200 shadow-lg shadow-brand-teal/20"
          >
            Send Us a Message
